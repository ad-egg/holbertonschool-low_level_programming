...
This function inserts a node as the left-child of another node.
### 2-binary_tree_insert_right.c
This function inserts a node as the right-child of another node.
### 3-binary_tree_delete.c
This function deletes an entire binary tree.
### 4-binary_tree_is_leaf.c
This function checks if a node is a leaf.
### 5-binary_tree_is_root.c
This function checks if a given node is a root.
### 6-binary_tree_preorder.c
This function goes through a binary tree using pre-order traversal.
...
This function measures the depth of a node in a binary tree.
